...
class _DaktariDetailsScreenState extends State<DaktariDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.daktari.name),
      ),
      body: Column(
        children: [
                ...
                .map((time) => InkWell(
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color:
                              selectedTime == time ? Colors.blue : Colors.grey,
                    ...
                    showDialog(
                      ...
                      builder: (BuildContext context) {
                        return AlertDialog(
                          ...
                          content: Text(
                              'Your appointment with ${widget.daktari.name} is scheduled for ${DateFormat('EEE, MMM d, h:mm a').format(appointment.dateTime)}.'),
                          actions: [
                            TextButton(
                              child: Text('OK'),
                              onPressed: () {
